...
CREATE TABLE `alertastock` (
  ...
  `umbralStock` int DEFAULT NULL,
  `alertaActiva` tinyint(1) DEFAULT NULL,
  `fechaAlerta` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `alertastock` VALUES (1,1,30,1,'2024-10-04 17:27:18'),(2,4,15,1,'2024-10-04 17:27:18'),(3,6,20,1,'2024-10-04 17:27:18'),(4,9,10,1,'2024-10-04 17:27:18');
