...
CREATE TABLE `salidaproducto` (
  ...
  CONSTRAINT `salidaproducto_ibfk_1` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`),
  CONSTRAINT `salidaproducto_ibfk_2` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`)
...
INSERT INTO `salidaproducto` VALUES (1,1,1,20,'2024-10-04 17:38:00'),(2,7,3,10,'2024-10-04 17:38:00');
